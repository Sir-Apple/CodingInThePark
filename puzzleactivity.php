...
<html>
    ...
    <div class="iframe-container">
        <p align="center">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/uKVkmfYukz8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
</p>
    ...
    <p align="center"> <b> Note: This program is only available in PC website </b></p>
    <br>
    <center>
        <a class="button1" onclick="location.href = 'puzzlegame2.php'"><span> Check it out &#128269 </span></a>
    </center>
    </br>
    <br>
    <hr color="blue" style="width:65%" size="6">
    ...
    <br>
    <center>
        <a class="button1" onclick="location.href = 'puzzle.php'"><span> Play &#127918 </span></a>
    </center>
    <br>
    <br>
    <br>
